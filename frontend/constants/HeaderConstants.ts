...
export const TAB_HEADER_ENTRIES: Record<string, TabHeaderEntry> = {
  home:      { title: 'COMMAND BASE',    subtitle: 'PC Automation · Command Center',      actionLabel: 'QR SCAN',  actionIcon: 'qr-code-scanner', accentColor: '#FF2A1F' },
  butler:    { title: 'BUTLER AI',      subtitle: 'Local Ollama · Private · Zero Cloud', actionLabel: 'CLEAR',    actionIcon: 'delete-sweep',    accentColor: '#FFC400' },
  scripts:   { title: 'SCRIPT LIBRARY', subtitle: 'Python Automation · 70+ Scripts',     actionLabel: 'REFRESH',  actionIcon: 'refresh',         accentColor: '#FF2A1F' },
  knowledge: { title: 'KNOWLEDGE BASE', subtitle: 'SIGMA-NET · Live Crawler · KB Graph', actionLabel: 'SYNC',     actionIcon: 'sync',            accentColor: '#FFC400' },
  fileshare: { title: 'TOOLS HUB',      subtitle: 'File Share · Clipboard · Terminal',   actionLabel: 'REFRESH',  actionIcon: 'refresh',         accentColor: '#FF2A1F' },
  ...
  builder:   { title: 'SCRIPT BUILDER', subtitle: 'Visual Node Pipeline · Drag & Build', actionLabel: 'CLEAR',    actionIcon: 'delete-sweep',    accentColor: '#FFC400' },
};
