...
const CAT_META: Record<string, {
  ...
  Files:       { title: 'File & Folder',         subtitle: 'Organize, backup, rename',       icon: 'folder',              iconLibrary: 'material',   color: '#FF8C00' },
  ...
  GUI:         { title: 'GUI Automation',         subtitle: 'Mouse, keyboard, windows',       icon: 'mouse',               iconLibrary: 'material',   color: '#B06EFF' },
  Email:       { title: 'Email & Notify',         subtitle: 'SMTP, Slack, Discord, alerts',   icon: 'email',               iconLibrary: 'material',   color: '#FF6FD8' },
  Data:        { title: 'Data Processing',        subtitle: 'CSV, Excel, PDF, SQLite',        icon: 'table-chart',         iconLibrary: 'material',   color: '#FFD700' },
  Scheduling:  { title: 'Scheduling',             subtitle: 'Cron, timers, automation',       icon: 'schedule',            iconLibrary: 'material',   color: '#00D4FF' },
  Setup:       { title: 'Setup & DevOps',         subtitle: 'Dev env, Docker, git, CI/CD',    icon: 'build',               iconLibrary: 'material',   color: '#FF8C00' },
  ...
  Privacy:     { title: 'Privacy & Protection',   subtitle: 'Block, shred, WiFi, DNS, VPN',   icon: 'privacy-tip',         iconLibrary: 'material',   color: '#C084FF' },
